...
class external_links_admin
{
	...
	function update_options()
	{
		...
		$options['add_iframe']=isset($options['add_iframe']);
	...
	function admin_page()
	{
		...
		echo '<tr>'
			...
			. '<input type="checkbox"'
				...
				. ' />'
			. '&nbsp;'
			. __('Process all outbound links as configured below. This means links in the sidebars, header, footer and so on in addition to those in posts\' and pages\' content. Note: If you add a nofollow attribute, be sure to turn this off if you wish to let your commenters to have some Google Juice. icons are not added outside of the main area.')
			. '</label>'
			. '</td>'
			. '</tr>';
		...
		echo '<tr>'
			...
			. '<input type="checkbox"'
				...
				. ' />'
			. '&nbsp;'
			. __('Open outbound links in new windows. Some usability experts suggest <a href="http://www.facebook.com/profile.php?id=1158717098">this can damage your visitor\'s trust</a> towards your site. Others highlight that some users (mainly elderly) do not know how to use the back button and encourage the practice.')
			. '</label>'
			. '</td>'
			. '</tr>';
		...
		echo '<tr>'
			. '<td>'
			. '<label for="sem_external_links[add_iframe]">'
			. '<input type="checkbox"'
				. ' name="sem_external_links[add_iframe]" id="sem_external_links[add_iframe]"'
				. ( $options['add_iframe'] ? ' checked="checked"' : '' )
				. ' />'
			. '&nbsp;'
			. __('Open outgoing links in your own page, Then you can go back. Preview:<a href="http://uicss.cn">http://uicss.cn</a>')
			. '</label>'
			. '</td>'
			. '</tr>';
