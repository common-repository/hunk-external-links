<?php
/*
Plugin Name: Hunk External Links
Plugin URI: http://www.dhexuan.com/
...
Author: Hunk
Version: 3.0.5
Author URI: http://www.facebook.com/profile.php?id=1158717098
*/
...
class external_links
{
		...
		if ( $options['add_css'] )
		{
			echo '<link rel="stylesheet" type="text/css"'
				. ' href="'
					...
					. 'wp-content/plugins/hunk-external-links/hunk-external-links.css?ver=3.0'
					. '"'
				. ' />' . "\n";
		}
	...
	#	echo '</pre>';
			...
			)
		{
			...
			if ( $options['add_iframe'] )
			{
				
				preg_match('/(href=")(.*?)(".*)/i',$anchor,$iframe);
				
				$re="\$1wp-content/plugins/hunk-external-links/hunk-external-iframe.php?hr=".$iframe[2]."\$3";
				$anchor=preg_replace('/(href=")(.*?)(".*)/i',$re,$anchor);
...
if ( is_admin() )
{
	include dirname(__FILE__) . '/hunk-external-links-admin.php';
}
?>